...
class MainWindow(QMainWindow):
    ...
    def determine_page(self):
        if True:#self.page == "particle detection":
    ...
    def particle_detection_window(self):
        ...
        self.middle_layout.addWidget(self.video_widget)
        ...
        self.middle_layout.addWidget(self.photo_label)
        ...
        self.middle_layout.addLayout(self.frame_nav_layout)
        ...
        self.right_layout.addWidget(self.main_layout.right_panel)
        self.right_layout.addWidget(self.main_layout.right_panel)
    ...
    def trajectory_tracking_window(self):
        ...
        self.graph_layout = QVBoxLayout(self.main_layout.left_panel)
        ...
        self.left_layout = QVBoxLayout(self.main_layout.middle_panel)
